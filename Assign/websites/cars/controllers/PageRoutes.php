...
class PageRoutes implements \classes\GetRoutes
{
    ...
    public function getThePageController($controllerName)
    {
        ...
        //creating an object of the controller Cars
        $pageControllers['Login'] = new \controllers\controller\Login($tableOfAdministrators, $_GET, $_POST);
        ...
        //creating an object of the controller Cars
        $pageControllers['AdminManufacturers'] = new \controllers\controller\AdminManufacturers($tableOfManufacturers, $_GET, $_POST);

        //creating an object of the controller Cars
        $pageControllers['AdminArchive'] = new \controllers\controller\AdminArchive($tableOfArchives, $tableOfCars, $tableOfCarDescs, $_GET, $_POST);

        //creating an object of the controller Cars
        $pageControllers['Administrators'] = new \controllers\controller\Administrators($tableOfAdministrators, $_GET, $_POST);

        //creating an object of the controller Cars
        $pageControllers['Stories'] = new \controllers\controller\Stories($tableOfStories, $_GET, $_POST);

        //creating an object of the controller Cars
        $pageControllers['Contacts'] = new \controllers\controller\Contacts($tableOfContacts, $_GET, $_POST);

        //creating an object of the controller Cars
        $pageControllers['Manufacturers'] = new \controllers\controller\Manufacturers($tableOfManufacturers, $_GET, $_POST);
    ...
    public function adminLoginCheck($pageRoute)
    {
        ...
        $routesLoginNeed['Login/logoutAdmin'] = true;
